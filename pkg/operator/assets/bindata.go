        ...
        status:
          properties:
            ...
            installerImage:
              ...
              type: string
            pullSecret:
              description: PullSecret will hold the pull secret information which
                is used by cluster deployment
              type: object
          ...
          properties:
            ...
            globalPullSecret:
              description: GlobalPullSecret is used to specify a pull secret that
                ...
                with the specific pull secret for the cluster deployment, with precedence
                given to the contents of the pull secret for the cluster deployment.
              type: object
            managedDomains:
